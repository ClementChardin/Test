...
class Interface(Frame):
    ...
    def __init__(self, fenetre, **kwargs):
        ...
        """
        self.joueurs = Label(self.pack1, text=afficher_joueurs(self.charger_equipe().joueurs), background='white', anchor="w", justify=LEFT)
        self.pack1.add(self.joueurs)
    ...
    def commande_radio(self):
        ...
        commande_radio = self.joueurs.configure(text=afficher_joueurs(self.charger_equipe().joueurs), background='white', anchor="w", justify=LEFT)
