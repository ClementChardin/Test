...
class Col3Widget(QtGui.QWidget):
    def __init__(self, parent=None, club=None):
        ...
        self.mod = QtGui.QStandardItemModel(40, 15)
        self.setup_model()
    ...
    def setup_model(self):
        ...
        c_lab = ["Nom"]
        for (k, v) in sorted(s.ordre_caracs_joueurs.items(), key = lambda (k,v): s.ordre_caracs_joueurs[k]):
            c_lab.append(k)
        for i in range(3):
            c_lab.append('poste'+str(i+1))
